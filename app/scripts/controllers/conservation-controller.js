(function() {
    ...
    angular
        ...
        .controller('ConservationCtrl', ConservationCtrl);

    ConservationCtrl.$inject = ['$window', '$scope', '$location', '$anchorScroll'];

    function ConservationCtrl($window, $scope, $location, $anchorScroll) {
