(function() {
    ...
    angular
        .module('eaa.directives.d3.interactive.wells', [])
        .directive('eaaGaugeDataInteractiveWells', eaaGaugeDataInteractiveWells);

    function eaaGaugeDataInteractiveWells() {
        ...
        directiveDefinitionObject.link = function postLink(scope, element) {
            ...
            var stage2 = slideStages.append('div')
                .attr('x', '0%')
                .attr('y', function() {
                    return (Number(stage1.y + stage1.height + 5) + 'px').toString();
                })
            ...
            var stage3 = slideStages.append('div')
                .attr('x', '0%')
                .attr('y', function() {
                    return (Number(stage2.y + stage2.height + 5) + 'px').toString();
                })
            ...
            var stage4 = slideStages.append('div')
                .attr('x', '0%')
                .attr('y', function() {
                    return (Number(stage3.y + stage3.height + 5) + 'px').toString();
                })
            ...
            var stage5 = slideStages.append('div')
                .attr('x', '0%')
                .attr('y', function() {
                    return (Number(stage4.y + stage4.height + 5) + 'px').toString();
                })
