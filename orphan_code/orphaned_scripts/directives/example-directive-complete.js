...
angular.module('d3-visualizations', [])
  .directive('eaaAquifersBoundaryMap', function() {
    ...
    // WITH COMPILE PROPERTY.
    // If a compile property is defined:
    directiveDefinitionObject.compile = function(tElement, tAttributes) {  // transclude is deprecated.
      // Return Options:
      // OPTION A
      ...
      // console.log('linkFunction: ', linkFunction);
      return linkFunction;
    };
    ...
    // }
    // OPTION D
    // directiveDefinitionObject.link: function postLink( ... ) { ... }
